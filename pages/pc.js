      ...
      <div className='center'>
        ...
        <div className='absolute top-10 flex flex-col items-center justify-center'>
          ...
          <div className='flex mx-5 gap-5'>
            <div className=''>
              <Image className='object-fit' width={400} height={420} src={Images.pc1} alt='khuyenmai' />
            </div>
            <div className='flex flex-col gap-5'>
              <Image className=' object-fit' width={200} height={200} src={Images.pc2} alt='khuyenmai' />
              <Image className=' object-fit' width={200} height={200} src={Images.pc3} alt='khuyenmai' />
            </div>
          </div>
        </div>
      </div>
